            ...
            <div className='Hackaton-announcement'>
                <div className='hack-Line'>
                    ...
                    <div className='announcement'>
                        <h4 className=''>Hackathon Announcement</h4>
                    ...
                    <div className='announcement'>
                        <h4 className=''>November 18, 2023</h4>
                    </div>

                    <div className='announcement'>
                        <h4 className=''>Teams Registration endst</h4>
                        <p className='techHackathon announce'>
                    ...
                    <div className='announcement'>
                        <h4 className=''>Getlinked Hackathon 1.0 Offically Begins</h4>
                        <p className='techHackathon announce'>
                ...
                <div className='timeline-subtopic'>
                    ...
                    <div className='announcement'>
                        <h4 className=''>Teams Registration begins</h4>
                        <p className='techHackathon announce'>
                    ...
                    <div className='announcement'>
                        <h4 className=''>Announcement of the accepted teams<br />
                            and ideas</h4>
                        <p className='techHackathon announce'>
